...
namespace NewTechParentPortalV3.Controllers
{
    ...
    public class ParentsController : Controller
    {
        ...
        public ParentsController(PortalContext context, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                parents = parents.Where(p => p.Email.Contains(searchString));
            }
            ...
            return View(await parents.AsNoTracking().ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstMidName,Address,Telephone,Email")] Parent parent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstMidName,Address,Telephone,Email")] Parent parent)
        {
            if (id != parent.ID)
            {
                return NotFound();
